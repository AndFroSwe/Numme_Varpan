...
for i = 1:3
    ...
    fprintf('Vid uw = -%i �r vinnande kastvinklar �r %0.2f och %0.2f grader.\n',uw2,angle_high,angle_low)
    figure
...
fprintf('Relativt fel f�r RK4 med stegl�ngd %0.4f �r %f%%\r', h, abs(rel_err_RK4*100))
...
fprintf('Konvergensber�kning har maximal avvikelse %0.2f*10^-3\r', max(abs(deviations))*1e3)
